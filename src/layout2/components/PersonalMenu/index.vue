      ...
      <div class="left-menu rounded-12px overflow-hidden mb-9">
        ...
        <div class="user-money w-full color-#8491a5">
          ...
          <div class="money-container text-12px justify-around">
            <div class="money-icon-box flex flex-col items-center cursor-pointer group" @click.prevent="handleClick('recharge')">
              <div class="relative">
                <img class="icon-normal w-8 h-8" src="@/assets/images/home/icon-deposit.png" alt="">
                <img class="icon-active w-8 h-8 absolute top-0 left-0" src="@/assets/images/home/icon-deposit-a.png" alt="">
              </div>
              <span class="group-hover:text-[var(--el-color-primary)]">{{ $t("web.i18nFront.label.recharge") }}</span>
            </div>
            <div class="money-icon-box flex flex-col items-center cursor-pointer group" @click.prevent="handleClick('transfor')">
              <div class="relative">
                <img class="icon-normal w-8 h-8" src="@/assets/images/home/icon-transfor.png" alt="">
                <img class="icon-active w-8 h-8 absolute top-0 left-0" src="@/assets/images/home/icon-transfor-a.png" alt="">
              </div>
              <span class="group-hover:text-[var(--el-color-primary)]">{{ $t("web.i18nFront.label.transfor") }}</span>
            </div>
            <div class="money-icon-box flex flex-col items-center cursor-pointer group" @click.prevent="handleClick('withdraw')">
              <div class="relative">
                <img class="icon-normal w-8 h-8" src="@/assets/images/home/icon-withdraw.png" alt="">
                <img class="icon-active w-8 h-8 absolute top-0 left-0" src="@/assets/images/home/icon-withdraw-a.png" alt="">
              </div>
